...
<title>TrungNam Shoes - Administrator</title>
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">TrungNam Shoes - Administrator</div>
				<div class="panel-body">
					...
					<form role="form" method="post">
						<fieldset>
							...
							<div class="checkbox">
								<label>
									<input require="" name="remember" type="checkbox" value="Remember Me">Nhớ tài khoản
								</label>
							</div>
